...
class AppStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, vpc: ec2.IVpc, **kwargs) -> None:
        ...
        role = iam.Role(self, "AWS-Lambda-Policy", assumed_by=iam.ServicePrincipal("lambda.amazonaws.com"))
        ...
        code_llama_apigw_endpoint = apigw.LambdaRestApi(
            self, "code_llama_apigw_endpoint",
            handler=lambda_code_llama
        )
    ...
    def apigw(self) -> apigw.LambdaRestApi.url:
        return self.code_llama_apigw_endpoint.uri