...
from deploy_constructs.sagemaker_studio_constructs import SagemakerStudioDomainConstruct, SagemakerStudioUserConstruct
...
class SagemakerStudioStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, vpc: ec2.IVpc, **kwargs) -> None:
        ...
        self.public_subnet_ids = [public_subnet.subnet_id for public_subnet in vpc.public_subnets]
        my_sagemaker_domain = SagemakerStudioDomainConstruct(self, "mySagemakerStudioDomain",
        ...
        my_default_datascience_user = SagemakerStudioUserConstruct(self,
                                                             "dsc-1",
			                                                 sagemaker_domain_id=my_sagemaker_domain.sagemaker_domain_id,
			                                                 user_profile_name="dsc-1")
        CfnOutput(self, f"cfnoutput-dsc-1",
